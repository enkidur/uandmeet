...
public class ChatRoomRepository {
    ...
    public ChatListMessageDto findAllRoom(Member member) {
        List<InvitedUsers> invitedUsers = invitedUsersRepository.findAllByUserId(member.getId());
     ...
     */
    @Transactional
    public void createChatRoom(Board board, UserDto userDto) {
        ChatRoom chatRoom = ChatRoom.create(board, userDto);
