...
public class RedisPublisher {
    ...
    public void publishsave( ChatMessageDto messageDto){
        ...
        String boardId = messageDto.getBoardId();
        //redis에 저장되어있는 리스트를 가져와, 새로 받아온 chatmessageDto를 더하여 다시 저장한다.
        List<ChatMessageDto> chatMessageList = opsHashChatMessage.get(CHAT_MESSAGE, boardId);
        ...
        opsHashChatMessage.put(CHAT_MESSAGE, boardId, chatMessageList);
